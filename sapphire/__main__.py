...
def main():
    ...
    parser.add_argument("--mock_num", type=int,default=0)
    parser.add_argument("--rng_sample", type=int,default=0)
    parser.add_argument("--chain_num", type=int,default=0)
    parser.add_argument("--rng_init", type=int,default=0)
    # parser.add_argument("--flag_smhm", type=int)
    # parser.add_argument("--flag_fgas", type=int)
    # parser.add_argument("--flag_mzr", type=int)  
    # parser.add_argument("--flag_sfms", type=int)  
    # parser.add_argument("--flag_mzr_gas", type=int)       
    # parser.add_argument("--mock_err_smhm", type=float,default=0.0) 
    # parser.add_argument("--mock_err_fgas", type=float,default=0.0) 
    # parser.add_argument("--mock_err_mzr", type=float,default=0.0) 
    # parser.add_argument("--mock_err_sfms", type=float,default=0.0)   
    # parser.add_argument("--mock_err_mzr_gas", type=float,default=0.0) 
    # parser.add_argument("--scale_err_smhm", type=float,default=1.0) 
    # parser.add_argument("--scale_err_fgas", type=float,default=1.0) 
